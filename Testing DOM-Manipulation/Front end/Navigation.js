...
const submit = document.getElementById("submit_bt")


navigation_list.addEventListener("click", submit)

function submit()
{
    main_content_change
    <p id="submitExec">
    Your ToDo has been saved under your Username. To access it, click the "Your ToDo List" tab in the navigation bar. 
  </p>
